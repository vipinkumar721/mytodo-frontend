...
// Naye props receive kar rahe hain for Edit Mode
const TodoForm = ({ editTodo, setEditTodo }) => {
  ...
  // Agar editTodo mein data aata hai, toh form mein bhar do
  useEffect(() => {
    if (editTodo) {
  ...
  const onSubmit = (e) => {
    ...
    // Check ki Edit kar rahe hain ya Naya bana rahe hain
    if (editTodo) {
      // Edit Mode
  ...
  <form onSubmit={onSubmit} className="flex flex-col gap-5">
    ...
    <div>
      ...
      <div className="relative border-2 border-dashed border-gray-300 bg-gray-50 rounded-xl p-4 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200 flex items-center">
        <input
          id="imageInput"
          type="file"
          accept="image/*"
