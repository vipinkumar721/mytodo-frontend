  ...
  <form onSubmit={onSubmit} className="flex flex-col gap-5">
    ...
    <div>
      ...
      <p className="text-xs text-gray-500 mb-3">
        Upload a photo or screenshot to help you remember the context of this task.
      </p>
      ...
      <div className="relative border-2 border-dashed border-gray-300 bg-gray-50 rounded-xl p-4 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200 flex items-center justify-between">
        <input
          ...
          className="w-full text-sm text-gray-600 file:mr-4 file:py-2.5 file:px-5 file:rounded-lg file:border-0 file:text-sm file:font-bold file:cursor-pointer file:bg-emerald-100 file:text-emerald-800 hover:file:bg-emerald-200 transition-colors cursor-pointer"
        />
        ...
        {image && (
          <button
            ...
            className="ml-3 p-1.5 text-red-600 flex-shrink-0 flex items-center gap-1.5 px-3 hover:bg-red-50 rounded-lg transition-colors"
