...
const Login = () => {
  ...
  <div className="text-center w-full max-w-lg">
    ...
    <h2 className="text-4xl font-extrabold text-emerald-900 mb-2">Welcome back</h2>
    <p className="text-sm text-gray-600 mb-8">Sign in to your account to continue taking notes</p>

    {/* Main Login Card */}
    <div className="w-full bg-white p-8 rounded-2xl shadow-xl shadow-gray-200 border border-gray-100">
      
      {/* Form Content */}
      <h3 className="text-2xl font-bold text-gray-900 text-center mb-1">Log In</h3>
      <p className="text-sm text-gray-500 text-center mb-6">Enter your email and password to access your notes</p>
      
      <form onSubmit={onSubmit} className="space-y-5 text-left">
        {/* Email Field */}
        <div>
          <label className="text-sm font-medium text-gray-700 block mb-1.5 text-left">Email</label>
          <input
            type="email"
            name="email"
            value={email}
        ...
        {/* Password Field */}
        <div>
          <label className="text-sm font-medium text-gray-700 block mb-1.5 text-left">Password</label>
          <input
            type="password"
            name="password"
            value={password}
      ...
      <div className="mt-6 pt-5 text-center border-t border-gray-100">
        <p className="text-sm text-gray-600">
          Don't have an account? <Link to="/register" className="font-semibold text-emerald-700 hover:text-emerald-800 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  </div>
